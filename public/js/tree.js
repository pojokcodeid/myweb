var NavTree = function (selector, options) {
  ...
  var props = {
    ...
    groupOpenIconClass: (options.groupOpenIconClass && options.groupOpenIcon) ? options.groupOpenIconClass : "bi",
    groupOpenIcon: (options.groupOpenIconClass && options.groupOpenIcon) ? options.groupOpenIcon : "bi-chevron-down",
    groupCloseIconClass: (options.groupCloseIconClass && options.groupCloseIcon) ? options.groupCloseIconClass : "bi",
    groupCloseIcon: (options.groupCloseIconClass && options.groupCloseIcon) ? options.groupCloseIcon : "bi-chevron-right",
    linkIconClass: (options.linkIconClass && options.linkIcon) ? options.linkIconClass : "bi",
